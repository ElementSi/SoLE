...
TEST(CSRTest, ConstructorTestM3x3)
{
    ...
    std::vector<size_t> columns {0, 1, 1, 1, 2};
    std::vector<size_t> rows {0, 2, 3, 5};
...
TEST(CSRTest, ZeroRowConstructorTestM3x3)
{
    ...
    std::vector<size_t> columns {0, 1, 1, 2};
    std::vector<size_t> rows {0, 2, 2, 4};
...
TEST(CSRTest, ZeroRowConstructorTestM5x3)
{
    ...
    std::vector<double> values {1, 2, 4, 2, 6};
    std::vector<size_t> columns {0, 1, 1, 1, 2};
    std::vector<size_t> rows {0, 2, 3, 3, 5, 5};
...
TEST(CSRTest, ZeroMatrixConstructorTestM3x3)
{
    ...
    std::vector<size_t> rows {0, 0, 0, 0};
